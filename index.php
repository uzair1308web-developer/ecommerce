...
<main id="MainContent" class="content-for-layout">
        ...
        <div class="collection-tab-inner mt-0">
            <div class="container">
                <div class="grid-container-2">
                    <a class="grid-item grid-item-1 position-relative rounded mt-0 d-flex" href="shop.php" data-aos="fade-right" data-aos-duration="700">
                    ...
                    <a class="grid-item grid-item-2 position-relative rounded mt-0 d-flex" href="shop.php" data-aos="fade-right" data-aos-duration="700">
                    ...
                    <a class="grid-item grid-item-3 position-relative rounded mt-0 d-flex" href="shop.php" data-aos="fade-left" data-aos-duration="700">
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6 col-6" data-aos="fade-up" data-aos-duration="700">
                        <div class="product-card">
                            <div class="product-card-img">
                                <a class="hover-switch" href="shop.php">
                                    <img class="secondary-img" src="assets/img/products/furniture/9.jpg" alt="product-img">
                                    <img class="primary-img" src="assets/img/products/furniture/1.jpg" alt="product-img">
                                </a>
                            ...
                            <div class="product-card-details">
                                ...
                                <h3 class="product-card-title">
                                    <a href="shop.php">best wood furniture</a>
                                </h3>
                    ...
                    <div class="col-lg-3 col-md-6 col-6" data-aos="fade-up" data-aos-duration="700">
                        <div class="product-card">
                            <div class="product-card-img">
                                <a class="hover-switch" href="shop.php">
                                    <img class="secondary-img" src="assets/img/products/furniture/10.jpg" alt="product-img">
                                    <img class="primary-img" src="assets/img/products/furniture/2.jpg" alt="product-img">
                                </a>
                            ...
                            <div class="product-card-details">
                                ...
                                <h3 class="product-card-title">
                                    <a href="shop.php">Vita Lounge Chair</a>
                                </h3>
                                <div class="product-card-price">
                                    <span class="card-price-regular">$1529</span>
                                    <span class="card-price-compare text-decoration-line-through">$1759</span>
                    ...
                    <div class="col-lg-3 col-md-6 col-6" data-aos="fade-up" data-aos-duration="700">
                        <div class="product-card">
                            <div class="product-card-img">
                                <a class="hover-switch" href="shop.php">
                                    <img class="secondary-img" src="assets/img/products/furniture/11.jpg" alt="product-img">
                                    <img class="primary-img" src="assets/img/products/furniture/3.jpg" alt="product-img">
                                </a>
                            ...
                            <div class="product-card-details">
                                ...
                                <h3 class="product-card-title">
                                    <a href="shop.php">Sarno Dining Chair</a>
                                </h3>
                                <div class="product-card-price">
                                    <span class="card-price-regular">$1529</span>
                                    <span class="card-price-compare text-decoration-line-through">$1759</span>
                    ...
                    <div class="col-lg-3 col-md-6 col-6" data-aos="fade-up" data-aos-duration="700">
                        <div class="product-card">
                            <div class="product-card-img">
                                <a class="hover-switch" href="shop.php">
                                    <img class="secondary-img" src="assets/img/products/furniture/14.jpg" alt="product-img">
                                    <img class="primary-img" src="assets/img/products/furniture/4.jpg" alt="product-img">
                                </a>
                            ...
                            <div class="product-card-details">
                                ...
                                <h3 class="product-card-title">
                                    <a href="shop.php">bisum tea table</a>
                                </h3>
                                <div class="product-card-price">
                                    <span class="card-price-regular">$1529</span>
                                    <span class="card-price-compare text-decoration-line-through">$1759</span>
                    ...
                    <div class="col-lg-3 col-md-6 col-6" data-aos="fade-up" data-aos-duration="700">
                        <div class="product-card">
                            <div class="product-card-img">
                                <a class="hover-switch" href="shop.php">
                                    <img class="secondary-img" src="assets/img/products/furniture/15.jpg" alt="product-img">
                                    <img class="primary-img" src="assets/img/products/furniture/5.jpg" alt="product-img">
                                </a>
                            ...
                            <div class="product-card-details">
                                ...
                                <h3 class="product-card-title">
                                    <a href="shop.php">Eliot Reversible tool</a>
                                </h3>
                                <div class="product-card-price">
                                    <span class="card-price-regular">$1529</span>
                                    <span class="card-price-compare text-decoration-line-through">$1759</span>
                    ...
                    <div class="col-lg-3 col-md-6 col-6" data-aos="fade-up" data-aos-duration="700">
                        <div class="product-card">
                            <div class="product-card-img">
                                <a class="hover-switch" href="shop.php">
                                    <img class="secondary-img" src="assets/img/products/furniture/16.jpg" alt="product-img">
                                    <img class="primary-img" src="assets/img/products/furniture/6.jpg" alt="product-img">
                                </a>
                            ...
                            <div class="product-card-details">
                                ...
                                <h3 class="product-card-title">
                                    <a href="shop.php">Vita Lounge wardrobe</a>
                                </h3>
                                <div class="product-card-price">
                                    <span class="card-price-regular">$1529</span>
                                    <span class="card-price-compare text-decoration-line-through">$1759</span>
                    ...
                    <div class="col-lg-3 col-md-6 col-6" data-aos="fade-up" data-aos-duration="700">
                        <div class="product-card">
                            <div class="product-card-img">
                                <a class="hover-switch" href="shop.php">
                                    <img class="secondary-img" src="assets/img/products/furniture/17.jpg" alt="product-img">
                                    <img class="primary-img" src="assets/img/products/furniture/7.jpg" alt="product-img">
                                </a>
                    ...
                    <div class="col-lg-3 col-md-6 col-6" data-aos="fade-up" data-aos-duration="700">
                        <div class="product-card">
                            <div class="product-card-img">
                                <a class="hover-switch" href="shop.php">
                                    <img class="secondary-img" src="assets/img/products/furniture/19.jpg" alt="product-img">
                                    <img class="primary-img" src="assets/img/products/furniture/8.jpg" alt="product-img">
                                </a>
                    ...
                    <div class="scattered-item" data-aos="fade-left" data-aos-duration="700">
                        <div class="scattered-wrapper">
                            ...
                            <div class="scattered-details">
                                ...
                                <a href="shop.php" class="text_12 link-underline d-block primary-color mt-2">
                                    SHOP COLLECTION
                                </a>
                            </div>
                        </div>
    ...
    <div class="video-section mt-100 overflow-hidden">
        <div class="overlay-furniture section-spacing" style="background: url('assets/img/video/video-furniture.jpg') no-repeat fixed bottom center/cover">
                            ...
                            <div class="video-button-area">
                                <a class="video-button" href="#video-modal" data-bs-toggle="modal">
                                    <svg width="22" height="26" viewBox="0 0 22 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M21.5 12.134C22.1667 12.5189 22.1667 13.4811 21.5 13.866L2 25.1244C1.33333 25.5093 0.499999 25.0281 0.499999 24.2583L0.5 1.74167C0.5 0.971867 1.33333 0.490743 2 0.875643L21.5 12.134Z" fill="#FEFEFE" />
                                    </svg>
                                </a>
                            </div>
                        </div>
            ...
            <div class="modal-dialog modal-dialog-centered modal-xl">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <iframe height="600" src="https://www.youtube.com/embed/tvPnrfQCiCo" title="YouTube video player" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="content-absolute content-slide">
                <div class="container height-inherit d-flex align-items-center justify-content-center">
                    <div class="content-box single-banner-content py-4 text-center" data-aos="fade-up" data-aos-duration="700">
                        ...
                        <a class="btn-primary single-banner-btn animate__animated animate__fadeInUp" href="shop.php" data-animation="animate__animated animate__fadeInUp" data-aos="fade-up" data-aos-duration="700">
                            DISCOVER NOW
                        </a>
                    </div>
                </div>
                ...
                <div class="article-card-container position-relative">
                    <div class="common-slider" data-slick='{
                        ...
                        <div class="article-slick-item" data-aos="fade-up" data-aos-duration="700">
                            <div class="article-card bg-transparent p-0 shadow-none">
                                <a class="article-card-img-wrapper" href="article.php">
                                    <img src="assets/img/blog/furniture-1.jpg" alt="img" class="article-card-img rounded">
                        ...
                        <div class="article-slick-item" data-aos="fade-up" data-aos-duration="700">
                            <div class="article-card bg-transparent p-0 shadow-none">
                                <a class="article-card-img-wrapper" href="article.php">
                                    <img src="assets/img/blog/furniture-2.jpg" alt="img" class="article-card-img rounded">
                        ...
                        <div class="article-slick-item" data-aos="fade-up" data-aos-duration="700">
                            <div class="article-card bg-transparent p-0 shadow-none">
                                <a class="article-card-img-wrapper" href="article.php">
                                    <img src="assets/img/blog/furniture-3.jpg" alt="img" class="article-card-img rounded">
                        ...
                        <div class="article-slick-item" data-aos="fade-up" data-aos-duration="700">
                            <div class="article-card bg-transparent p-0 shadow-none">
                                <a class="article-card-img-wrapper" href="article.php">
                                    <img src="assets/img/blog/furniture-4.jpg" alt="img" class="article-card-img rounded">
                                    <span class="article-tag article-tag-absolute rounded">Furniture</span>
                                </a>
                                <p class="article-card-published text_12 d-flex align-items-center">
                                    <span class="article-date d-flex align-items-center">
            ...
            <div class="container">
                <div class="contact-form-area">
                    <div class="section-header mb-4">
                        <h2 class="section-heading">Talk to HR</h2>
                        <p class="section-subheading">Our HR would like to hear from you.</p>
                    </div>
                    <div class="contact-form--wrapper">
                        <form class="contact-form" id="hr-form" method="POST">
                            <div class="row">
                                <div class="col-md-6 col-12">
                                    <fieldset>
                                        <input type="text" placeholder="Full name" name="name" value="" id="hr_name" />
                                    </fieldset>
                                </div>
                                <div class="col-md-6 col-12">
                                    <fieldset>
                                        <input type="email" placeholder="Email Address*" name="email" value="" id="hr_email" />
                                    </fieldset>
                                </div>
                                <div class="col-md-6 col-12">
                                    <fieldset>
                                        <input type="text" placeholder="Type a subject" name="subject" value="" id="hr_subject" />
                                    </fieldset>
                                </div>
                                <div class="col-md-6 col-12">
                                    <fieldset>
                                        <input type="text" placeholder="Phone Number" name="number" value="" id="hr_number" />
                                    </fieldset>
                                </div>
                                <div class="col-md-12 col-12">
                                    <fieldset>
                                        <textarea cols="20" rows="6" placeholder="Write your message here*" name="message" id="hr_message"></textarea>
                                    </fieldset>
                                    <div class="submit-box d-flex justify-content-between w-100">
                                        <button type="submit" name="submit" id="hr-form-btn" value="send" class="position-relative review-submit-btn contact-submit-btn">SEND MESSAGE</button>
                                        <div class="p-2" id="form-submit-div" role="alert">
...
<div class="modal fade" tabindex="-1" id="modal-subscribe-off">

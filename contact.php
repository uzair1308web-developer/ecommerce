                           ...
                           <div class="contact-form--wrapper">
                               <form action="" class="contact-form" id="contact-form" method="POST">
                                   <div class="row">
                                       <div class="col-md-6 col-12">
                                           <fieldset>
                                               <input type="text" placeholder="Full name" name="name" value="" id="contact_name" />
                                           </fieldset>
                                       </div>
                                       <div class="col-md-6 col-12">
                                           <fieldset>
                                               <input type="email" placeholder="Email Address*" value="" name="email" id="contact_mail" />
                                           </fieldset>
                                       </div>
                                       <div class="col-md-6 col-12">
                                           <fieldset>
                                               <input type="text" placeholder="Type a subject" value="" name="subject" id="contact_subject" />
                                           </fieldset>
                                       </div>
                                       <div class="col-md-6 col-12">
                                           <fieldset>
                                               <input type="text" placeholder="Phone Number" value="" name="number" id="contact_number" />
                                           </fieldset>
                                       </div>
                                       <div class="col-md-12 col-12">
                                           <fieldset>
                                               <textarea cols="20" rows="6" placeholder="Write your message here*" name="message" id="contact_message"></textarea>
                                           </fieldset>
                                           <div class="submit-box d-flex justify-content-between w-100">
                                               <button type="submit" name="submit" id="contact-form-btn" value="send" class="position-relative review-submit-btn contact-submit-btn">SEND MESSAGE</button>

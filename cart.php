                                        ...
                                        if (mysqli_num_rows($result) > 0) {
                                            ...
                                            <td class='cart-item-quantity'>
                                                <div class='quantity d-flex align-items-center justify-content-between'>
                                                    <button class='qty-btn dec-qty' onclick=updateQty('$productId','minus','cartPage_price$i','cartPage_qty$i')><img src='assets/img/icon/minus.svg' alt='minus'></button>
                                                    <input class='qty-input' type='number' id='cartPage_qty$i' name='qty' value='$item[quantity]'  min='0'>
                                                    <button class='qty-btn inc-qty' onclick=updateQty('$productId','plus','cartPage_price$i','cartPage_qty$i')><img src='assets/img/icon/plus.svg' alt='plus'></button>
                                                </div>
                                                <a href='' class='product-remove mt-2' onclick=remove_product('$item[product_id]')>Remove</a>
                                            </td>
                                            <td class='cart-item-price text-end'>
                                                <div class='product-price' id='cartPage_price$i'>$$new_price</div>
                                            </td>
                                        </tr> ";
                                            $i++;
                                        } else {
                    ...
                    <li class="menu-list-item nav-item has-dropdown active">
                        ...
                        <div class="submenu-transform submenu-transform-desktop">
                            ...
                            <ul class="submenu list-unstyled">
                                ...
                                <li class="menu-list-item nav-item-sub"><a class="nav-link-sub nav-text-sub" href="index-shoe.html">Home
                                        2</a>
                                </li>
                                <li class="menu-list-item nav-item-sub"><a class="nav-link-sub nav-text-sub" href="index-bag.html">Home
                                        3</a>
                                </li>
                                <li class="menu-list-item nav-item-sub"><a class="nav-link-sub nav-text-sub" href="index-tools.html">Home
                                        4</a>
                                </li>
                            </ul>
                        </div>
...
<!-- Mirrored from spreethemesprevious.github.io/bisum/html/cart.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 17 Oct 2023 06:13:10 GMT -->

...
<!-- Mirrored from spreethemesprevious.github.io/bisum/html/product-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 17 Oct 2023 06:13:01 GMT -->
                            ...
                            <div class="product-details ps-lg-4">
                                ...
                                <div class="product-accordion">
                                    <div class="product-accordion-item accordion-parent">
                                        <h4 class="accordion-header d-flex align-items-center justify-content-between accordion-btn">
                                            <span class="accordion-heading">Description</span>
                                        ...
                                        <div class="accordion-content accordion-child">
                                            ...
                                            <p>To test the product-</p>
                                            <ul class="mt-2 mb-0">
                                                <li>Apply a small amount of product on your skin in a discreet area, such as the inside of your wrist or your inner arm.</li>
                                                <li>Wait 48 hours to see if there’s a reaction.</li>
                                                <li>Check the area at 96 hours after application to see if you have a delayed reaction.</li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="product-accordion-item accordion-parent">
                                        <h4 class="accordion-header d-flex align-items-center justify-content-between accordion-btn">
                                            <span class="accordion-heading">Reviews</span>
                                            <span class="accordion-icon">
                                                <svg class="icon icon-dropdown" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#000" stroke-width="1" stroke-linecap="round" stroke-linejoin="round">
                                                    <polyline points="6 9 12 15 18 9"></polyline>
                                                </svg>
                                        ...
                                        <div class="accordion-content accordion-child">
                                            <div class="accordion-parent">
                                                ...
                                                <div class="review-header d-flex justify-content-between align-items-center">
                                                    ...
                                                    <button class="text_14 bg-transparent text-decoration-underline write-btn accordion-btn" type="button">Write a review</button>
                                                </div>
                                    ...
                                    <div class="product-accordion-item accordion-parent">
                                        <h4 class="accordion-header d-flex align-items-center justify-content-between accordion-btn">
                                            <span class="accordion-heading">Shipping</span>
                                            <span class="accordion-icon">
                                                <svg class="icon icon-dropdown" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#000" stroke-width="1" stroke-linecap="round" stroke-linejoin="round">
                                                    <polyline points="6 9 12 15 18 9"></polyline>
                                                </svg>
                                        ...
                                        <div class="accordion-content accordion-child">
                                            <p class="mb-0">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Maiores molestiae dolorem facere nesciunt cupiditate rem est, hic, eum expedita nulla voluptate deleniti dolores quidem tenetur!</p>
                                        </div>
                                    </div>
                                    <div class="product-accordion-item accordion-parent">
                                        <h4 class="accordion-header d-flex align-items-center justify-content-between accordion-btn">
                                            <span class="accordion-heading">Compatibility</span>
                                            <span class="accordion-icon">
                                                <svg class="icon icon-dropdown" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#000" stroke-width="1" stroke-linecap="round" stroke-linejoin="round">
                                                    <polyline points="6 9 12 15 18 9"></polyline>
                                                </svg>
                            ...
                            <div class="col-xl-4 col-lg-5 col-md-6 col-12 footer-widget">
                                <div class="footer-widget-inner">
                                    <h4 class="footer-logo">
                                        <a href="https://spreethemesprevious.github.io/"><img src="assets/img/logo-white.png" alt="bisum"></a>
                                    </h4>
...
<!-- Mirrored from spreethemesprevious.github.io/bisum/html/product-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 17 Oct 2023 06:13:02 GMT -->
</html>
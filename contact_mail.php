...
$sql = "SELECT * FROM mail_data WHERE mail_of ='contact'";
$result = mysqli_query($conn, $sql);
...
$body = "<table border='1px solid red' cellspacing='0' cellpadding='6px'>
     ...
     $reciever_body = "<table width='100%' style='width:100%'>
     <tbody>
...
$send_mail =  sendMail($_POST['email'], "Thank You for contacting", $reciever_body);

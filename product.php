        ...
        <div class="container">
            <div class="row">
                        ...
                        <div class="product-img-large">
                            <div class="img-large-slider common-slider" data-slick='{
                                ...
                                <div class="img-large-wrapper">
                                    <a href="admin/upload/<?php echo $single_img[0]; ?>" data-fancybox="gallery">
                                        <img src="admin/upload/<?php echo $single_img[0]; ?>" alt="img">
                                    </a>
                                </div>
                                ...
                                if (isset($_GET['id'])) {
                                    ...
                                    if (mysqli_num_rows($result) > 0) {
                                        while ($row = mysqli_fetch_assoc($result)) {
                                            ...
                                            $multipleImg = image_parse($row['other_images']);
                                            // $uploadImages = json_decode($row['other_images'], true);
                                            
                                            foreach ($multipleImg as $single_image) {
                                            //    echo($single_image);
                                ?>
                                                <div class="img-large-wrapper">
                                                    <a href="admin/upload/<?php echo $single_image ?>" data-fancybox="gallery">
                                                        <img src="admin/upload/<?php echo $single_image ?>" alt="img">
                                                    </a>
                                                </div>
                                <?php
                                            }
                ...
                if (isset($_GET['id'])) {
                    ...
                    if (mysqli_num_rows($result) > 0) {
                        $row = mysqli_fetch_assoc($result);
                        $discount_price = $row['price'] - $row['offer_price'];
                    }
                }
                ?>
                <div class="col-lg-6 col-md-12 col-12">
                    <div class="product-details ps-lg-4">
                        <h2 class="product-title mb-3"><?php echo $row['product_name'] ?></h2>
                        <div class="product-rating d-flex align-items-center mb-3">


                        </div>
                        <form class="product-form" method="post" id="cart-form" onsubmit="addToCart(event)">
                            ...
                            <div class="product-price-wrapper mb-4">
                                <span class="product-price regular-price">$<?php echo $row['offer_price'] ?></span>
                                <del class="product-price compare-price ms-2">$<?php echo $row['price'] ?></del>
                            </div>
                            <div class="product-sku product-meta mb-1">
                                <strong class="label">SKU:</strong><?php echo $row['sku'] ?>
                            </div>

                            <input type="hidden" name="prod_name" value="<?php echo $row['product_name'] ?>">
                            <input type="hidden" name="price" value="<?php echo $row['offer_price'] ?>">
                            <input type="hidden" name="actual_price" value="<?php echo $row['price']?>">
                            <input type="hidden" name="pro_id" value="<?php echo $pro_id ?>">
                            <input type="hidden" name="disc_price" value="<?php echo $discount_price?>">
                            ...
                            <div class="misc d-flex align-items-end justify-content-between mt-4">
                                <div class="quantity d-flex align-items-center justify-content-between">
                                    <button type="button" class="qty-btn update-qty-btn dec-qty"><img src="assets/img/icon/minus.svg" alt="minus"></button>
                                    <input class="qty-input" type="number" name="qty" value="1" min="1">
                                    <button type="button" class="qty-btn update-qty-btn inc-qty"><img src="assets/img/icon/plus.svg" alt="plus"></button>
                                </div>
                            ...
                            <div class="product-form-buttons d-flex align-items-center justify-content-between mt-4">
                                <div class="w-100" id="add-to-cart-btn">
                                    <?php
                                    if (isset($_SESSION['cart'][$pro_id])) {
                                        echo  '<a href="cart.php" class="text-light"><button type="button" name="cart" class="position-relative btn-atc btn-add-to-cart">GO TO CART</button></a>';
                                    } else {
                                        echo '<button type="submit" name="cart" class="position-relative btn-atc btn-add-to-cart">ADD TO CART</button>';
                                    }
                            ...
                            <div class="buy-it-now-btn mt-2">
                                <a href="cart.php"><button name="cart" class="position-relative btn-atc btn-buyit-now" onclick="addtocartt(event)">BUY IT NOW</button></a>
                            </div>
                        </form>
                    ...
                    <div class="row">
                        <div class="col-lg-8 col-md-12 col-12">
                            <div class="desc-content">
                                <h4 class="heading_18 mb-3"><?php echo $row['product_name'] ?></h4>
                                <p class="text_16 mb-4">Lorem ipsum dolor sit amet conse ctetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Lorem ipsum dolor sit amet conse ctetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Lorem ipsum dolor sit amet conse ctetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Lorem ipsum dolor sit amet conse ctetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-12 col-12">
                            <div class="desc-img">
                                <img src="admin/upload/<?php echo $row['product_img'] ?>" alt="img" height="400px">
                            </div>
                        </div>
                                ...
                                <div class="product-card">
                                    <div class="product-card-img">
                                        <a class="hover-switch" href="product.php?id=<?php echo $row['id'] ?>">
                                            <img class="secondary-img" src="admin/upload/<?php echo $row['product_img'] ?>" alt="product-img">
                                            <img class="primary-img" src="admin/upload/<?php echo $row['product_img'] ?>">
                                        </a>
                                    ...
                                    <div class="product-card-details text-center">
                                        <h3 class="product-card-title"><a href="collection-left-sidebar.html"><?php echo $row['product_name'] ?></a>
                                        </h3>
                                        <div class="product-card-price">
                                            <span class="card-price-regular">$<?php echo $row['offer_price'] ?></span>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-12 col-12">
                        <div class="product-details ps-lg-4">
                            ...
                            <div class="misc d-flex align-items-end justify-content-between mt-4">
                                <div class="quantity d-flex align-items-center justify-content-between">
                                    <button class="qty-btn update-qty-btn dec-qty"><img src="assets/img/icon/minus.svg" alt="minus"></button>
                                    <input class="qty-input" type="number" name="qty" value="1">
                                    <button class="qty-btn update-qty-btn inc-qty"><img src="assets/img/icon/plus.svg" alt="plus"></button>
                                </div>
                                <div class="message-popup d-flex align-items-center">
                                    <span class="message-popup-icon">
                                        <svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">

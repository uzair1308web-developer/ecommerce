                                    ...
                                    <ul class="filter-lists list-unstyled mb-0">
                                        <li class='filter-item'>
                                            <label class='filter-label'>
                                                <a href="shop.php" class="text-dark ">
                                                    <span class='filter-text'>All<span></a>
                                            </label>
                                        </li>
                                        <?php while ($row = mysqli_fetch_assoc($result)) {
                                            ...
                                            echo "<li class='filter-item'>
                                                <label class='filter-label'>
                                                <a href='shop.php?cat_id={$row['id']}' class='text-dark'>
                                                    <span class='filter-text'>{$row['category_name']}<span></a>
                                                    </label>
                                                    </li>";
                                        } ?>
                                    </ul>
                                ...
                                ?>
                                        <div class="related-item d-flex">
                                            <div class="related-img-wrapper">
                                                <img class="related-img" src="admin/upload/<?php echo $single_img[0] ?>" alt="img">
                                            </div>
                                            <div class="related-product-info">
                                                ...
                                                <p class="related-price text_16">$<?php echo $row['offer_price'] ?></p>
                                            </div>
                                        </div>
                                <?php }
                                } ?>

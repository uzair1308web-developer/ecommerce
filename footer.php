                    ...
                    <div class="col-xl-2 col-lg-2 col-md-6 col-12 footer-widget">
                        <div class="footer-widget-inner">
                            ...
                            <ul class="footer-menu list-unstyled mb-0 d-md-block">
                                <li class="footer-menu-item"><a href="about-us.php">About us</a></li>
                                <li class="footer-menu-item"><a href="about-us.php">Press center</a></li>
                                <li class="footer-menu-item"><a href="blog.php">Our magazine</a></li>
                                <li class="footer-menu-item"><a href="about-us.php">Our group</a></li>
                                <li class="footer-menu-item"><a href="about-us.php">Work with us</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-xl-2 col-lg-2 col-md-6 col-12 footer-widget">
                        <div class="footer-widget-inner">
                            ...
                            <ul class="footer-menu list-unstyled mb-0 d-md-block">
                                <li class="footer-menu-item"><a href="about-us.php">Brand catalog</a></li>
                                <li class="footer-menu-item"><a href="about-us.php">Discount codes</a></li>
                                <li class="footer-menu-item"><a href="collection-left-sidebar.php">Furniture</a></li>
                                <li class="footer-menu-item"><a href="collection-left-sidebar.php">Sofa</a></li>
                                <li class="footer-menu-item"><a href="collection-left-sidebar.php">Chair</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-xl-2 col-lg-2 col-md-6 col-12 footer-widget">
                        <div class="footer-widget-inner">
                            ...
                            <ul class="footer-menu list-unstyled mb-0 d-md-block">
                                <li class="footer-menu-item"><a href="faq.php">FAQ</a></li>
                                <li class="footer-menu-item"><a href="about-us.php">Privacy policy</a></li>
                                <li class="footer-menu-item"><a href="about-us.php">Support</a></li>
                                <li class="footer-menu-item"><a href="contact.php">Contact</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-5 col-md-6 col-12 footer-widget">
                        <div class="footer-widget-inner">
                            <h4 class="footer-logo">
                                <a href="https://spreethemesprevious.github.io/"><img src="assets/img/logo-accent.png" alt="bisum"></a>
                            </h4>
        ...
        <div class="container">
            <div class="footer-bottom-inner d-flex flex-wrap justify-content-md-between justify-content-center align-items-center">
                <ul class="footer-bottom-menu list-unstyled d-flex flex-wrap align-items-center mb-0">
                    <li class="footer-menu-item"><a href="about-us.php">Privacy policy</a></li>
                    <li class="footer-menu-item"><a href="about-us.php">Terms & Conditions</a></li>
                </ul>
...
<script src="mail-handle.js?v=<?php echo time() ?>"></script>
<script>
</script>